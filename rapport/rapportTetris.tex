...
\section*{Introduction}
	...
	\bigskip
	Nous étions intéressé par ce projet car nous voulions améliorer nos connaissances dans le language C++. 


	De plus la simplicité de la conception d'un Tétris nous permettait d'approfondir certains domaines spécifiques liés au développement, tel que approfondir la programmation distribuée et la sérialisation nous motivait pour ce projet.
...
\section{La communication}
	\subsection{Le serveur}
		...
		\begin{figure}[bt]
			\centering
			\includegraphics[scale=0.45]{img/ser.png}
